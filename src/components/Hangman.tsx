...
function App() {
  ...
  const renderHangman = () => {
    const hangmanParts = [
      <circle key="head" cx="80" cy="33" r="10" stroke="white" strokeWidth="3" fill="none" />, // Head
      <line key="body" x1="80" y1="41" x2="80" y2="70" stroke="white" strokeWidth="3" />, // Body
      <line key="left-arm" x1="80" y1="50" x2="65" y2="45" stroke="white" strokeWidth="3" />, // Left arm
      <line key="right-arm" x1="80" y1="50" x2="95" y2="45" stroke="white" strokeWidth="3" />, // Right arm
      <line key="left-leg" x1="80" y1="70" x2="65" y2="85" stroke="white" strokeWidth="3" />, // Left leg
      <line key="right-leg" x1="80" y1="70" x2="95" y2="85" stroke="white" strokeWidth="3" />, // Right leg
    ];

    return (
      <svg height="120" width="100" className="hangman">
        {hangmanParts.slice(0, wrongGuesses)}
        <line x1="10" y1="100" x2="90" y2="100" stroke="white" strokeWidth="3" /> {/* Base */}
        <line x1="50" y1="10" x2="50" y2="100" stroke="white" strokeWidth="3" /> {/* Pole */}
        <line x1="50" y1="10" x2="80" y2="10" stroke="white" strokeWidth="3" /> {/* Top */}
        <line x1="80" y1="10" x2="80" y2="25" stroke="white" strokeWidth="3" /> {/* Rope */}
      </svg>
    );
  };
